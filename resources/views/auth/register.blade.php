    ...
    <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <div class="hidden xl:flex flex-col min-h-screen">
            <a href="" class="-intro-x flex items-center pt-5">
                <img alt="Đơn vị thiết kế IT24h" class="w-6" src="{{ asset('upload/images/common_img/logo.svg') }}">
                <span class="text-white text-lg ml-3"> IT24h</span> </span>
            </a>
            <div class="my-auto">
                <img alt="Đơn vị thiết kế IT24h" class="-intro-x w-1/2 -mt-16" src="{{ asset('upload/images/common_img/illustration.svg') }}">
        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
            <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-dark-1 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                ...
                <div class="intro-x mt-8">
                    <input type="text" class="intro-x login__input form-control py-3 px-4 border-gray-300 block" placeholder="Họ tên"
                    ...
                    <input type="email" class="intro-x login__input form-control py-3 px-4 border-gray-300 block mt-4" placeholder="Email"
                    ...
                    @enderror
                    <input type="password" class="intro-x login__input form-control py-3 px-4 border-gray-300 block mt-4" placeholder="Mật khẩu"
                    ...
                    <input type="password" class="intro-x login__input form-control py-3 px-4 border-gray-300 block mt-4" placeholder="Nhập lại mật khẩu"
                ...
                <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                    ...
                    <a href="{{route('login')}}" class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Đăng nhập</a>
                </div>
                </form>
            </div>
        </div>
