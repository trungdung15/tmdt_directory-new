...
<div class="intro-y col-span-12 overflow-auto lg:overflow-visible" id="data">
    <table class="table table-report -mt-2" id="myTable">
        ...
        <tr>
            ...
            <th class="whitespace-nowrap">Bài viết</th>
        ...
        @foreach($votes as $vote)
            ...
            <tr class="intro-x" id="{{$vote->id}}">
                <td class="w-10">
                    <div class="text-center whitespace-nowrap">{{$t}}</div>
                </td>
                <td class="w-52">
                ...
                <td class="table-report__action w-10">
                    <div class="flex justify-center items-center">
                        @can('updatePost',\App\Models\Vote::class)
                            <a href="{{route('vote.editPost',['id'=>$vote->id])}}" title="Chỉnh sửa"
                               class="btn btn-sm btn-primary mr-2">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                        @endcan
                        @can('deletePost',\App\Models\Vote::class)
                        ...
                        <div class="modal-header">
                            ...
                            @can('updatePost',\App\Models\Vote::class)
                                <div class="sm:w-auto flex mt-4 sm:mt-0">
                                    <a href="{{route('vote.editPost',['id'=>$vote->id])}}" class="btn btn-primary shadow-md mr-2">Sửa</a>
                                </div>
                            @endcan
                            ...
                            <div class="col-span-12">
                                <div>
                                    <div class="truncate sm:whitespace-normal items-center">
                                        <strong class="mr-2">Bài viết:</strong>
                                        {{$vote->post_title}}
                                    </div>
...
<div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center" id="pagi">
    ...
    <form action="{{route('vote.indexPost')}}" id="form-limit">
