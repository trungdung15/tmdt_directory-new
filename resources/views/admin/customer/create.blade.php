                                    ...
                                    <div class="col-span-12">
                                        ...
                                        <div class="mt-2">
                                            <select class="tom-select w-full" name="gender">
                                                ...
                                                <option value="Nam" @if (old('gender') == 'Nam')
                                                    selected
                                                @endif>Nam</option>
                                                <option value="Nữ" @if (old('gender') == "Nữ")
                                                selected
                                                @endif>Nữ</option>
                                                <option value="Gới tính khác" @if (old('gender') == "Gới tính khác")
                                                selected
                                                @endif>Giới tính khác</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="w-52 mx-auto xl:mr-0 xl:ml-6">
                                <div
                                    ...
                                    <div class="mx-auto cursor-pointer relative mt-5">
                                        <label for="avatar" class="btn btn-primary w-full cursor-pointer">Chọn ảnh đại diện</label>
